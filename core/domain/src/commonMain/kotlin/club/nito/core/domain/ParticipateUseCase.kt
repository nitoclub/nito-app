...
public sealed interface ParticipateUseCase {
    public suspend operator fun invoke(scheduleId: String, status: ParticipantStatus): ExecuteResult<Unit>
}
...
public class ParticipateExecutor(
    ...
    override suspend fun invoke(scheduleId: String, status: ParticipantStatus): ExecuteResult<Unit> = runExecuting {
